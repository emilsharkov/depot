...
describe("useStorageState", () => {
  ...
  describe("initialization and lifecycle", () => {
    ...
    it("writes initialValue to storage when storage is empty", () => {
      renderHook(() => useStorageState("key", "initial", mockStorage));
      expect(mockStorage.getItem("key")).toBe(JSON.stringify("initial"));
    });
